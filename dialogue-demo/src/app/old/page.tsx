...
//   const [pendingLLMContent, setPendingLLMContent] = useState<string | null>(null);
...
//                 pendingLLMContent={pendingLLMContent}
//                 onLLMContentApplied={() => setPendingLLMContent(null)}
